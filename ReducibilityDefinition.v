...
Ltac simp_red := autorewrite with reducible_values in *.
Ltac simp_red_hyp := autorewrite with reducible_values in * |-.
Ltac simp_red_goal := autorewrite with reducible_values in |- *.
